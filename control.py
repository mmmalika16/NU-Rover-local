#!/usr/bin/env python3
"""
Optimized ROS 2 Humble Robotic Arm Controller
Supports 3 ODrive controllers for multi-axis robotic arm control
"""
import odrive
import os
import time
...
class ArmController(Node):
    ...
    def _connect_to_odrives(self):
        ...
        try:
            ...
            for axis_name, axis in self.axes.items():
                ...
                while axis.current_state not in [AXIS_STATE_IDLE, AXIS_STATE_CLOSED_LOOP_CONTROL]:
    ...
    def joy_callback(self, msg: Joy):
        ...
        velocity2 = msg.axes[5] * 2
        velocity1 = msg.axes[4] * 2
